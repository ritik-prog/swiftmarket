...
const Sidebar = () => {
  ...
  return (
    <aside
      className="flex flex-col w-70 h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700"
      id="default-sidebar"
      aria-label="Sidebar"
    >
        ...
        <div className="mt-6">
          ...
          >
            ...
            <span
              ...
              className="cursor-pointer text-gray-500 transition-colors duration-200 rotate-180 dark:text-gray-400 rtl:rotate-0 hover:text-blue-500 dark:hover:text-blue-400"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
